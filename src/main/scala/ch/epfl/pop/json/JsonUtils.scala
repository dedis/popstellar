...
object JsonUtils {
  ...
  final class MessageContentDataBuilder() {
    ...
    def setId(id: HexString): MessageContentDataBuilder = { this.id = id; this }
    ...
    def setMessageId(id: HexString): MessageContentDataBuilder = { this.message_id = id; this }
