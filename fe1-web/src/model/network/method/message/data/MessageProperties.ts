...
export const messagePropertiesMap: Map<ObjectType, Map<ActionType, MessageProperties>> = new Map([
  [
    ObjectType.CHIRP,
    new Map<ActionType, MessageProperties>([
  ...
  [
    ObjectType.REACTION,
    new Map<ActionType, MessageProperties>([[ActionType.ADD, { isPopTokenSigned: true }]]),
  ],
  [
    ObjectType.ELECTION,
    new Map<ActionType, MessageProperties>([
  ...
  [
    ObjectType.MESSAGE,
    new Map<ActionType, MessageProperties>([[ActionType.WITNESS, { isPopTokenSigned: false }]]),
  ],
]);
