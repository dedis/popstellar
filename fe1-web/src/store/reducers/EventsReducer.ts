...
import { Hash, LaoEvent, LaoEventState, eventFromState, RollCall, PublicKey } from 'model/objects';
...
export const makeEventsAliasMap = () =>
  createSelector(
    // First input: Get all events across all LAOs
    (state) => getEventsState(state),
    // Second input: get the current LAO id,
...
export const makeLastRollCallAttendeesList = (
  laoId: Hash | string,
