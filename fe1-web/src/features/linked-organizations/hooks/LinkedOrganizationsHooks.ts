...
import { LINKED_ORGANIZATIONS_FEATURE_IDENTIFIER, LinkedOrganizationsReactContext } from '../interface';
...
export namespace LinkedOrganizationsHooks {
  export const useLinkedOrganizationsContext = (): LinkedOrganizationsReactContext => {
    ...
    console.log("heeere");
    console.log(LINKED_ORGANIZATIONS_FEATURE_IDENTIFIER);
   ...
   */
  export const useIsLaoOrganizer = (laoId: Hash) => useLinkedOrganizationsContext().useIsLaoOrganizer(laoId);
}
