...
module.exports = {
  forbidden: [
    ...
    {
      name: 'not-from-pop-core-to-features',
      comment:
    ...
    */
    ...
    reporterOptions: {
      dot: {
         ...
         */
        collapsePattern: `^${collapseAliases}|${collapseTests}|node_modules/[^/]+`,
      ...
      archi: {
        ...
        */
        collapsePattern: `${collapseAliases}|${collapseTests}|node_modules|(features|core)/[^/]+`,
