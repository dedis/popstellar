const STRINGS = {
  ...
  hide_encrypted_seed_title: 'HIDE ENCRYPTED SEED',
  wallet_state_null: 'null',
  wallet_state_show_seed: 'show_seed',
  wallet_state_set_seed: 'set_seed',
  wallet_state_initialized: 'wallet_initialized',
