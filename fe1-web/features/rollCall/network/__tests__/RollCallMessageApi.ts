...
const initializeChecks = () => {
  checkDataCreateRollCall = (obj: MessageData) => {
    ...
    expect(data).toContainKeys([...defaultMessageDataFields, 'id', 'name', 'creation',
      'location', 'proposed_start', 'proposed_end']);
  ...
  checkDataOpenRollCall = (obj: MessageData) => {
    ...
    expect(data).toBeObject();
    expect(data).toContainKeys([...defaultMessageDataFields, 'update_id', 'opens',
      'opened_at']);
  ...
  checkDataCloseRollCall = (obj: MessageData) => {
    ...
    expect(data).toBeObject();
    expect(data).toContainKeys([...defaultMessageDataFields, 'update_id', 'closes',
      'closed_at', 'attendees']);
    expect(data.update_id).toBeBase64Url();
...
describe('MessageApi', () => {
  it('should create the correct request for requestCreateRollCall without description',
    async () => {
      await msApi.requestCreateRollCall(mockEventName, mockLocation, mockStartTime, mockEndTime);
    });

  it('should create the correct request for requestCreateRollCall with description',
    async () => {
  ...
  it('should create the correct request for requestOpenRollCall without start time',
    async () => {
  ...
  it('should create the correct request for requestOpenRollCall with start time',
    async () => {
  ...
  it('should create the correct request for requestReopenRollCall without start time',
    async () => {
  ...
  it('should create the correct request for requestReopenRollCall with start time',
    async () => {
  ...
  it('should create the correct request for requestCloseRollCall without attendees',
    async () => {
  ...
  it('should create the correct request for requestCloseRollCall with attendees',
    async () => {
  ...
  it('should create the correct request for requestCloseRollCall with end time',
    async () => {
