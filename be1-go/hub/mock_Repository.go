...
func (_m *MockRepository) GetElectionQuestions(electionID string) (map[string]question, error) {
	ret := _m.Called(electionID)
	...
	var r0 map[string]question
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (map[string]question, error)); ok {
		return rf(electionID)
	}
	if rf, ok := ret.Get(0).(func(string) map[string]question); ok {
		r0 = rf(electionID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]question)
		}
	}
