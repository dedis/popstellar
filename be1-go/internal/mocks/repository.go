...
import (
	...
	method "popstellar/internal/message/query/method"
...
func (_m *Repository) CheckRumor(senderID string, rumorID int) (bool, error) {
...
func (_m *Repository) GetAndIncrementMyRumor() (bool, method.Rumor, error) {
	ret := _m.Called()
...
func (_m *Repository) GetFederationExpect(senderPk string, remotePk string, Challenge messagedata.FederationChallenge, channelPath string) (messagedata.FederationExpect, error) {
...
func (_m *Repository) GetFederationInit(senderPk string, remotePk string, Challenge messagedata.FederationChallenge, channelPath string) (messagedata.FederationInit, error) {
	ret := _m.Called(senderPk, remotePk, Challenge, channelPath)
...
func (_m *Repository) GetParamsHeartbeat() (map[string][]string, error) {
	ret := _m.Called()
...
func (_m *Repository) GetUnprocessedMessagesByChannel() (map[string][]message.Message, error) {
	ret := _m.Called()
...
func (_m *Repository) IsChallengeValid(senderPk string, challenge messagedata.FederationChallenge, channelPath string) error {
...
func (_m *Repository) RemoveChallenge(challenge messagedata.FederationChallenge) error {
...
func (_m *Repository) StoreRumor(rumorID int, sender string, unprocessed map[string][]message.Message, processed []string) error {
...
func (_m *Repository) StoreServerKeys(electionPubKey kyber.Point, electionSecretKey kyber.Scalar) error {
