...
func Test_handleChannelLao(t *testing.T) {
	...
	args = append(args, input{
		name: "Test 12",
		msg: newElectionSetupMsg(t, ownerPublicKey, wrongSender, laoID, laoID, electionsName, question, melection.OpenBallot,
	...
	args = append(args, input{
		name: "Test 13",
		msg: newElectionSetupMsg(t, ownerPublicKey, ownerPubBuf64, wrongLaoID, laoID, electionsName, question, melection.OpenBallot,
			creation, start, end, true, db),
		channelPath: laoID,
		isError:     true,
	...
	args = append(args, input{
		name: "Test 14",
		msg: newElectionSetupMsg(t, ownerPublicKey, ownerPubBuf64, laoID, laoID, "wrongName", question, melection.OpenBallot,
			creation, start, end, true, db),
		channelPath: laoID,
		isError:     true,
	...
	args = append(args, input{
		name: "Test 15",
		msg: newElectionSetupMsg(t, ownerPublicKey, ownerPubBuf64, laoID, laoID, electionsName, question, melection.OpenBallot,
	...
	args = append(args, input{
		name: "Test 17",
		msg: newElectionSetupMsg(t, ownerPublicKey, ownerPubBuf64, laoID, laoID, electionsName, "", melection.OpenBallot,
			creation, start, end, true, db),
		channelPath: laoID,
		isError:     true,
	...
	args = append(args, input{
		name: "Test 18",
		msg: newElectionSetupMsg(t, ownerPublicKey, ownerPubBuf64, laoID, laoID, electionsName, wrongQuestion, melection.OpenBallot,
			creation, start, end, true, db),
		channelPath: laoID,
		isError:     true,
...
func newElectionSetupMsg(t *testing.T, organizer kyber.Point, sender,
	...
	electionSetupID := messagedata.Hash(
		melection.ElectionFlag,
		setupLao,
		strconv.Itoa(int(createdAt)),
		"electionName",
	)

	var questions []melection.ElectionSetupQuestion
	...
	questions = append(questions, melection.ElectionSetupQuestion{
		ID:            questionID,
		Question:      question,
