...
// AddGetMessagesByID provides a mock function with given fields: ID
func (_m *Queries) AddGetMessagesByID(ID int) error {
	ret := _m.Called(ID)

	if len(ret) == 0 {
		panic("no return value specified for AddGetMessagesByID")
	}
