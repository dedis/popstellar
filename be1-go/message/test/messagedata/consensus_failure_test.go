...
func Test_Consensus_Failure_Not_Base64_Instance(t *testing.T) {
	file := filepath.Join(relativeExamplePath, "consensus_failure", "wrong_failure_not_base_64_instance.json")
...
func Test_Consensus_Failure_Not_Base64_Message(t *testing.T) {
	file := filepath.Join(relativeExamplePath, "consensus_failure", "wrong_failure_not_base_64_message.json")
...
func Test_Consensus_Failure_Negative_Created_At(t *testing.T) {
	file := filepath.Join(relativeExamplePath, "consensus_failure", "wrong_failure_negative_created_at.json")
