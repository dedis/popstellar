...
@Database(entities = {LAO.class, Meeting.class, LAOWitnessCrossRef.class, RollCall.class, Person.class, ModificationSignature.class}, version = 1, exportSchema = true)
            ...
            synchronized (LAODatabase.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            LAODatabase.class, DATABASE_NAME)
                            .build();
                }
            }
        }
