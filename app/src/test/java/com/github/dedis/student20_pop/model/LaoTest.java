...
public class LaoTest {
    ...
    private static final List<Event> EVENTS_WITH_NULL = Arrays.asList(
            new MeetingEvent("meeting", 0, 0, LAO_FOR_EVENTS.getId(), "loc", "desc"),
            null,
            new PollEvent("question", 0, 0, LAO_FOR_EVENTS.getId(), "loc", new ArrayList<>(), false));
    ...
    private static final List<Lao> LAOS_WITH_NULL = new ArrayList<>(Arrays.asList(LAO_1, null, LAO_FOR_EVENTS));
    ...
    public void setAndGetNameTest() {
        ...
        assertThat((LAO_1.setName(LAO_NAME_2)).getName(), is(LAO_NAME_2));
    }
    ...
    public void getIdsTest() {
        assertThat(Lao.getIds(LAOS), is(new ArrayList<>(Arrays.asList(LAO_1.getId(), LAO_FOR_EVENTS.getId()))));
    }
