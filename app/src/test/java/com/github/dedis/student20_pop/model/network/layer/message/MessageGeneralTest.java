package com.github.dedis.student20_pop.model.network.layer.message;
...
public class MessageGeneralTest {
    ...
    private final MessageGeneral messageGeneral1 = new MessageGeneral(sender1.getPublicKey(), data, signature1, messageId1, new ArrayList<>());
    private final MessageGeneral messageGeneral2 = new MessageGeneral(sender2.getPublicKey(), data, signature2, messageId2, new ArrayList<>());

    @Test
    public void createMessageGeneralWithNullParametersTest() {
        assertThrows(IllegalArgumentException.class, () -> new MessageGeneral(null, data, signature1, messageId1, new ArrayList<>()));
        assertThrows(IllegalArgumentException.class, () -> new MessageGeneral(sender1.getPublicKey(), null, signature1, messageId1, new ArrayList<>()));
        assertThrows(IllegalArgumentException.class, () -> new MessageGeneral(sender1.getPublicKey(), data, null, messageId1, new ArrayList<>()));
        assertThrows(IllegalArgumentException.class, () -> new MessageGeneral(sender1.getPublicKey(), data, signature1, null, new ArrayList<>()));
        assertThrows(IllegalArgumentException.class, () -> new MessageGeneral(sender1.getPublicKey(), data, signature1, messageId1, null));
    }
