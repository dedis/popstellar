...
public class SimpleSocketTest {
    ...
    @Test
    public void startServer() throws DeploymentException, TimeoutException, InterruptedException {
        //Setup
        ...
        new Thread(() -> {
            try {
                ClientSession session = PoPClientEndpoint.connectToServer(URI.create("ws://localhost:2000/"));
                for(String s : toSend)
