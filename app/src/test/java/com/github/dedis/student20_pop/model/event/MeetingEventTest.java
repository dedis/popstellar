...
public class MeetingEventTest {
    ...
    private final MeetingEvent event1 = new MeetingEvent(name1, startTime, endTime, lao, location, description);
    private final MeetingEvent event2 = new MeetingEvent(name2, startTime, endTime, lao, location, description);

    @Test
    public void createEventWithNullParametersTest() {
        assertThrows(IllegalArgumentException.class, () -> new MeetingEvent(name1, startTime, endTime, lao, location, null));
    }
