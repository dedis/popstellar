...
public class RollCallEventTest {
    ...
    private final RollCallEvent event1 = new RollCallEvent(name1, startTime, endTime, lao, attendees, location, description);
    private final RollCallEvent event2 = new RollCallEvent(name2, startTime, endTime, lao, attendees, location, description);

    @Test
    public void createEventWithNullParametersTest() {
        assertThrows(IllegalArgumentException.class, () -> new RollCallEvent(name2, startTime, endTime, lao, null, location, description));
        assertThrows(IllegalArgumentException.class, () -> new RollCallEvent(name2, startTime, endTime, lao, attendees, location, null));
    }
