...
object FederationResultExample {
  ...
  final val ORGANIZER: PublicKey = PublicKey(Base64Data("UvViTxoKsB3XVP_ctkmOKCJpMWb7fCzrcb1XDmhNe7Q="))
  final val CHALLENGE_MESSAGE: FederationChallenge = FederationChallenge.buildFromJson(CHALLENGE.data.decodeToString())
  ...
  final val RESULT_1: FederationResult = FederationResult(STATUS_1, ORGANIZER, CHALLENGE_MESSAGE)
  final val RESULT_2: FederationResult = FederationResult(STATUS_2, REASON, CHALLENGE_MESSAGE)
