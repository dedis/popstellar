...
object MessageExample {
  ...
  lazy val rollCallCreateBadID: CreateRollCall = new CreateRollCall(Hash(Base64Data("ywPSfeTuaTK5fQ785xfDQVEZbJWbavVwikB-HCDfv7I=")), "Roll Call ", Timestamp(1633098853), Timestamp(1633099125), Timestamp(1633099140), "EPFL", Some("Food is welcome!"))
  final val MESSAGE_CREATEROLLCALL_BAD_ID: Message =  new Message(
    Base64Data.encode(rollCallCreateBadID.toString()),
    organizerRollCall,
    Signature(Base64Data.encode(rollCallCreateBadID.toString())),
    Hash(Base64Data("bgmzJEyaNoEQo3sA-Zky8pTZ9gMRjSW27ljm1vEPXMI=")),
    List.empty,
    Some(rollCallCreate)
  )
