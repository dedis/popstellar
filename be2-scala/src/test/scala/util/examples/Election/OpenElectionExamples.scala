...
object OpenElectionExamples {
  ...
  final val ELECTION_ID: Hash = Hash.fromStrings("Election", LOA_ID.toString, NOT_STALE_CREATED_AT.toString, ELECTION_NAME)
  ...
  val workingSetupElection: SetupElection = SetupElection(ELECTION_ID, LOA_ID, ELECTION_NAME, ELECTION_VERSION, NOT_STALE_CREATED_AT, NOT_STALE_START_TIME, NOT_STALE_END_TIME, QUESTIONS)
  ...
  val wrongTimestampSetupElection: SetupElection = SetupElection(ELECTION_ID, LOA_ID, ELECTION_NAME, ELECTION_VERSION, invalidTimestamp, NOT_STALE_START_TIME, NOT_STALE_END_TIME, QUESTIONS)
  ...
  val wrongTimestampOrderSetupElection: SetupElection = SetupElection(ELECTION_ID, LOA_ID, ELECTION_NAME, ELECTION_VERSION, NOT_STALE_CREATED_AT, NOT_STALE_END_TIME, NOT_STALE_START_TIME, QUESTIONS)
