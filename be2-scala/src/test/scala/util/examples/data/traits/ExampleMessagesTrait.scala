...
import ch.epfl.pop.model.objects.{PublicKey,Base64Data,Channel}
...
trait ExampleMessagesTrait {
  ...
  /**
    *
    * @param fileName file name of the .json file to get the payload from
    * @param messageBuilder mid level Message to use as base for HighLevelMessage
    * @return a parsed and decoded JsonRpcRequest
    */
  ...
  /**
    ...
    * @param highLevelMessage high level message builder for the payload
    * @return a parsed and decoded JsonRpcRequest
    */
