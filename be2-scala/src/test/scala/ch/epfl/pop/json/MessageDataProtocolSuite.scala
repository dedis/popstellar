...
class MessageDataProtocolSuite extends FunSuite with Matchers {
  ...
  test("Parser correctly decodes a EndElection message data") {
    ...
    val expected = EndElection(Hash(Base64Data("GX9slST3yY_Mltkjimp-eNq71mfbSbQ9sruABYN8EoM=")), Hash(Base64Data("zG1olgFZwA0m3mLyUqeOqrG0MbjtfqShkyZ6hlyx1tg=")), Timestamp(1633099883L), Hash(Base64Data("tAUYpZDc7lOfrxyviK6V9UsezeubGUZR-TpwF52pzWU=")))
