 ...
 * @note Warning: The PrivateKey/PublicKey pair used through the signature process should be generated using Ed25519Sign.KeyPair
 *       Usage example (from SignatureSuite.scala):
