...
final case class PagedCatchup(override val channel: Channel, numberOfMessages: Int, beforeMessageID: Option[String] = None) extends Params {
...
object PagedCatchup extends Parsable {
  ...
  def apply(channel: Channel, numberOfMessages: Int, beforeMessageID: Option[String] = None): PagedCatchup = {
