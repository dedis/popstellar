...
object MessageRegistry {
  ...
  def apply(): MessageRegistry = {
    ...
    // data roll call
    register.add((ObjectType.ROLL_CALL, ActionType.CREATE), createSchemaVerifier("dataCreateRollCall.json"), CreateRollCall.buildFromJson, RollCallValidator.validateCreateRollCall, RollCallHandler.handleCreateRollCall)
    register.add((ObjectType.ROLL_CALL, ActionType.OPEN), createSchemaVerifier("dataOpenRollCall.json"), OpenRollCall.buildFromJson, r => RollCallValidator.validateOpenRollCall(r), RollCallHandler.handleOpenRollCall)
    register.add((ObjectType.ROLL_CALL, ActionType.REOPEN), createSchemaVerifier("dataOpenRollCall.json"), ReopenRollCall.buildFromJson, RollCallValidator.validateReopenRollCall, RollCallHandler.handleReopenRollCall)
    register.add((ObjectType.ROLL_CALL, ActionType.CLOSE), createSchemaVerifier("dataCloseRollCall.json"), CloseRollCall.buildFromJson, RollCallValidator.validateCloseRollCall, RollCallHandler.handleCloseRollCall)
    ...
    // data social media
    register.add((ObjectType.CHIRP, ActionType.ADD), createSchemaVerifier("dataAddChirp.json"), AddChirp.buildFromJson, SocialMediaValidator.validateAddChirp, SocialMediaHandler.handleAddChirp)
    register.add((ObjectType.CHIRP, ActionType.DELETE), createSchemaVerifier("dataDeleteChirp.json"), DeleteChirp.buildFromJson, SocialMediaValidator.validateDeleteChirp, SocialMediaHandler.handleDeleteChirp)
    register.add((ObjectType.CHIRP, ActionType.NOTIFY_ADD), createSchemaVerifier("dataNotifyAddChirp.json"), NotifyAddChirp.buildFromJson, SocialMediaValidator.validateNotifyAddChirp, SocialMediaHandler.handleNotifyAddChirp)
    register.add((ObjectType.CHIRP, ActionType.NOTIFY_DELETE), createSchemaVerifier("dataNotifyDeleteChirp.json"), NotifyDeleteChirp.buildFromJson, SocialMediaValidator.validateNotifyDeleteChirp, SocialMediaHandler.handleNotifyDeleteChirp)
