...
func ComposeBroadcastStateLAO(lao event.LAO, laoData message.DataCreateLAO, orgPublicKey string) (queryStr []byte, err_ error) {
	...
	content := message.Message{
		...
		Signature:         nil, //TODO get signature from received Message
