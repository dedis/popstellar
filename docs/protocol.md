...
For now, this message is to be used to retrieve chirps a the social media channel specific for a given user (e.g. `/root/lao_id/social/chirps/{user_public_key}`) 
