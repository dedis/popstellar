...
public class JsonConverterTest {
  ...
  public void testJsonDataToBase64PrintsInDesiredFormat() {
    ...
    Json testConverter = jsonConverter.createPublishMessage(testJson.toString(), 2, "/root");
  ...
  public void constructJsonMessageFromDataCorrespondsToTrueJsonMessage() {
    ...
    Json jsonValidLaoMessage = jsonConverter.createPublishMessage(laoDataJsonString, 1, "/root");
