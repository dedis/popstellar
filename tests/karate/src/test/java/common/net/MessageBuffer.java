...
public interface MessageBuffer {
  ...
  /**
   * @param filter of the message, must return true for the valid message Some useful filters are
   *     implemented in {@link MessageFilters}
  ...
  /**
   * Removes and returns the first message left in the buffer. If the buffer is empty, returns null
   *
  ...
  /**
   * Removes and returns the first message left in the buffer matching the filter. If no message
   ...
   *
   * <p>If the buffer is empty, wait at most timeout for a new message to come. If after the timeout
   * the buffer is still empty, returns null
   *
   ...
   *
   * <p>If no match is found, wait at most timeout for a new messages to come. If after the timeout
   * there is still no match, returns null
   *
   * @param filter of the message, must return true for the valid message Some useful filters are
   *     implemented in {@link MessageFilters}
   * @param timeout in millis
