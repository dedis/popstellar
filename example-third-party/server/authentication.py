...
def get_url(server: str, user_token: str, client_id: str) -> str :
    ...
    url = baseUrl.format(server_url = server, id = client_id ,state = user_token, nonce = secrets.token_urlsafe(32))
