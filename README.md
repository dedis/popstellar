...
- **app dependencies**:
  ...
  - we use [react-navigation](https://reactnavigation.org/) to handle all the navigation between the different view. The package works great with the native platforms, but as some design issue in the web.
- **dev dependencies**:
