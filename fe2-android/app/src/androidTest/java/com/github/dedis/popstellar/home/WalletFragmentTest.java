...
public class WalletFragmentTest {
  ...
  public void ContentOfNewWalletUITest() {
    ...
    ViewInteraction textView = onView(
        allOf(withId(R.id.title_wallet), withText("Tokens"),
            withParent(allOf(withId(R.id.fragment_content_wallet),
                withParent(withId(R.id.fragment_container_home)))),
            isDisplayed()));
    ...
    ViewInteraction textView3 = onView(
        allOf(withText("Your wallet is empty"),
            withParent(allOf(withId(R.id.welcome_screen),
  ...
  public void SetUpWithSeedWalletUITest() {
    ...
    ViewInteraction editText = onView(
        allOf(withText("elbow six card empty next sight turn quality capital please vocal indoor"),
            withParent(allOf(withId(R.id.custom),
                withParent(withId(R.id.customPanel)))),
            isDisplayed()));
    editText.check(matches(
  ...
  public void LogoutWalletUITest() {
    ...
    ViewInteraction textView = onView(
        allOf(withId(R.id.alertTitle), withText("Log out"),
            withParent(allOf(withId(R.id.title_template),
                withParent(withId(R.id.topPanel)))),
            isDisplayed()));
