...
public class ProtocolTest {
  ...
  public void testTimeout() throws DeploymentException, TimeoutException, InterruptedException {
    ...
    HighLevelProxy proxy =
        ProtocolProxyFactory.getInstance()
            .createHighLevelProxy(URI.create("ws://" + HOST_NAME + ":" + PORT + "/"), bob, null);
  ...
  public void testCreateRollCall()
    ...
    proxy
        .createRollCall(
            LAO_ID, ROLL_CALL_NAME, 0, 0, CreateRollCall.StartType.SCHEDULED, LOCATION, DESCRIPTION)
        .whenComplete(
            (i, t) -> {
              waiter.assertTrue(t == null);
              waiter.assertEquals(i, 0);
    ...
    proxy
        .createRollCall(LAO_ID, ROLL_CALL_NAME, 0, 0, CreateRollCall.StartType.SCHEDULED, LOCATION)
        .whenComplete(
            (i, t) -> {
              waiter.assertTrue(t == null);
              waiter.assertEquals(i, 0);
