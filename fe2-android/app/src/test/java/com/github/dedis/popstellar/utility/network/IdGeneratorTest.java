package com.github.dedis.popstellar.utility.network;
...
public class IdGeneratorTest {
  ...
  public void generateCreateMeetingIdTest() {
    ...
    String expectedId = Hash
        .hash(EventType.MEETING.getSuffix(), laoId, Long.toString(createMeeting.getCreation()),
            createMeeting.getName());
  ...
  public void generateOpenRollCallIdTest() {
    ...
    String expectedId = Hash.hash(EventType.ROLL_CALL.getSuffix(), laoId, openRollCall.getOpens(),
        Long.toString(openRollCall.getOpenedAt()));
  ...
  public void generateElectionVoteIdWriteInEnabledTest() {
    ...
    String expectedId = Hash
        .hash(IdGenerator.SUFFIX_ELECTION_VOTE, id, electionVote.getQuestionId(),
            electionVote.getWriteIn());
  ...
  public void generateElectionVoteIdWriteDisabledTest() {
    ...
    String expectedId = Hash
        .hash(IdGenerator.SUFFIX_ELECTION_VOTE, id, electionVote.getQuestionId(),
            electionVote.getVotes().toString());
    assertThat(electionVote.getId(), is(expectedId));
