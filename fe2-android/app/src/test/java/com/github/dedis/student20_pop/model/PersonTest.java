...
public class PersonTest {
  ...
  public void createPersonWithNullParameters() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> new Person(name1, null, keys.getPrivateKey(), laos));
    assertThrows(
        IllegalArgumentException.class, () -> new Person(name1, keys.getPublicKey(), null, laos));
    assertThrows(
        IllegalArgumentException.class,
