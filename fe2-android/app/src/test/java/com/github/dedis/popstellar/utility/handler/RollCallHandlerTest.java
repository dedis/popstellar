package com.github.dedis.student20_pop.utility.handler;

import static com.github.dedis.student20_pop.utility.handler.MessageHandler.handleMessage;
import static com.github.dedis.student20_pop.utility.handler.RollCallHandler.closeRollCallWitnessMessage;
import static com.github.dedis.student20_pop.utility.handler.RollCallHandler.createRollCallWitnessMessage;
import static com.github.dedis.student20_pop.utility.handler.RollCallHandler.openRollCallWitnessMessage;
...
import com.github.dedis.student20_pop.model.data.LAOState;
...
public class RollCallHandlerTest {
  ...
  public void testHandleCreateRollCall() {
    ...
    WitnessMessage expectedMessage = createRollCallWitnessMessage(message.getMessageId(),
        rollCallOpt.get());
  ...
  public void testHandleOpenRollCall() {
    ...
    // Check the Witness message contains the expected title and description
    WitnessMessage expectedMessage = openRollCallWitnessMessage(message.getMessageId(),
        rollCallOpt.get());
    assertEquals(expectedMessage.getTitle(), witnessMessage.get().getTitle());
    assertEquals(expectedMessage.getDescription(), witnessMessage.get().getDescription());
  }
  ...
  public void testHandleCloseRollCall() {
    ...
    // Check the Witness message contains the expected title and description
    WitnessMessage expectedMessage = closeRollCallWitnessMessage(message.getMessageId(),
        rollCallOpt.get());
    assertEquals(expectedMessage.getTitle(), witnessMessage.get().getTitle());
    assertEquals(expectedMessage.getDescription(), witnessMessage.get().getDescription());
  }
