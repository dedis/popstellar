...
import static com.github.dedis.student20_pop.utility.handler.ElectionHandler.electionSetupWitnessMessage;
...
public class ElectionHandlerTest extends TestCase {
  ...
  public void testHandleElectionSetup() {
    ...
    WitnessMessage expectedMessage = electionSetupWitnessMessage(message.getMessageId(),
        electionOpt.get());
