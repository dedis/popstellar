...
public class ElectionSetupTest {
  ...
  public void fieldsCantBeNull() {
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(null, start, end, votingMethod, writeIn, ballotOptions, question,
            laoId));
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, start, end, null, writeIn, ballotOptions,
            question, laoId));
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, start, end, votingMethod, writeIn, null,
            question, laoId));
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, start, end, votingMethod, writeIn, ballotOptions,
            null, laoId));
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, start, end, votingMethod, writeIn, ballotOptions,
            question, null));
  ...
  public void endCantHappenBeforeStart() {
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, 2, 1, votingMethod, writeIn, ballotOptions,
            question, laoId));
  }
  ...
  public void timestampsCantBeNegative() {
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, -1, end, votingMethod, writeIn, ballotOptions,
            question, laoId));
    assertThrows(IllegalArgumentException.class,
        () -> new ElectionSetup(electionSetupName, start, -1, votingMethod, writeIn, ballotOptions,
            question, laoId));
  }
