...
public class ElectionPrivateKeyTest {
  ...
  public void equalsTest() {
    ...
    ElectionPrivateKey that = scheme.decryptionScheme;
  ...
  public void decryptTest() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> validDecryptionScheme.decrypt(wrongBase64Encoding));

    String wrongLengthMessage = "LX-_Hw==";
    assertThrows(
        IllegalArgumentException.class, () -> validDecryptionScheme.decrypt(wrongLengthMessage));
  }
}
