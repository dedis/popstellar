...
class LinkedOrganizationsScannerJoinTest {
    ...
    var activityScenarioRule: ActivityFragmentScenarioRule<LaoActivity, QrScannerFragment> =
            ActivityFragmentScenarioRule.launchIn(
                ...
                newInstance(ScanningAction.FEDERATION_JOIN)
            }
    ...
    fun addingManualLaoInfoWorks() {
        ...
        val input4 = QrScanningPageObject.manualInputWithHintRes(R.string.manual_add_organization_challenge_hint)
        Assert.assertNotNull(input4)
        input4.perform(forceTypeText(CHALLENGE.value))
