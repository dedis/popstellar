...
public class SocialMediaFollowingFragmentTest {
  ...
  @Rule(order = 3)
  public ActivityFragmentScenarioRule<LaoActivity, SocialMediaFollowingFragment>
      activityScenarioRule =
          ActivityFragmentScenarioRule.launchIn(
              LaoActivity.class,
              new BundleBuilder().putString(Constants.LAO_ID_EXTRA, LAO_ID).build(),
              LaoActivityPageObject.containerId(),
              SocialMediaFollowingFragment.class,
              SocialMediaFollowingFragment::new);
