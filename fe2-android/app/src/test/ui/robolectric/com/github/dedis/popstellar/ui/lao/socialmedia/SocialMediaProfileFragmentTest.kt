...
import com.github.dedis.popstellar.testutils.pages.lao.socialmedia.SocialMediaProfilePageObject
...
class SocialMediaProfileFragmentTest {
  ...
  @JvmField
  @Rule(order = 3)
  var activityScenarioRule: ActivityFragmentScenarioRule<LaoActivity, SocialMediaProfileFragment> =
    ActivityFragmentScenarioRule.launchIn(
      ...
      SocialMediaProfileFragment::class.java
    ) {
      SocialMediaProfileFragment()
    }

  @Test
  fun testBackButtonBehaviour() {
    SocialMediaProfilePageObject.getRootView().perform(ViewActions.pressBack())
    // Check current fragment displayed is home fragment
    SocialMediaProfilePageObject.getSocialMediaHomeFragment()
  ...
  fun handleRotationTest() {
    activityScenarioRule.scenario.onActivity { activity: LaoActivity ->
      ...
      Assert.assertTrue(after is SocialMediaProfileFragment)
    }
  }
