...
class CastVoteOpenBallotFragmentTest {
  ...
  @Test
  fun laoTitleMatches() {
    CastVoteFragmentPageObject.castVoteLaoTitle()
      .check(ViewAssertions.matches(ViewMatchers.withText(LAO_NAME)))
  }

  @Test
  fun electionTitleMatches() {
    CastVoteFragmentPageObject.castVoteElectionName()
      .check(ViewAssertions.matches(ViewMatchers.withText(TITLE)))
  }

  @Test
  fun question1ElementsAreDisplayed() {
    Espresso.onView(ViewMatchers.withText(ELECTION_QUESTION_TEXT1))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT11))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT12))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT13))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
  }

  @Test
  fun question2ElementsAreDisplayed() {
    CastVoteFragmentPageObject.castVotePager().perform(ViewActions.swipeLeft())

    Espresso.onView(ViewMatchers.withText(ELECTION_QUESTION_TEXT2))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT21))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT22))
      .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
  }

  @Test
  fun castVoteButtonIsEnabledWhenAnElementIsClicked() {
    ...
    CastVoteFragmentPageObject.castVoteButton()
      .check(ViewAssertions.matches(ViewMatchers.isEnabled()))
  }

  @Test
  fun castVoteSendsACastVoteMessage() {
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT11)).perform(ViewActions.click())
    CastVoteFragmentPageObject.castVotePager().perform(ViewActions.swipeLeft())
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT22)).perform(ViewActions.click())
  ...
  @Test
  fun swipeDoNotClearSelectionTest() {
    Espresso.onView(ViewMatchers.withText(ELECTION_BALLOT_TEXT11)).perform(ViewActions.click())

    CastVoteFragmentPageObject.castVotePager().perform(ViewActions.swipeLeft())
    CastVoteFragmentPageObject.castVotePager().perform(ViewActions.swipeRight())

    InstrumentationRegistry.getInstrumentation().waitForIdleSync()

    CastVoteFragmentPageObject.castVotePager()
      .check(ViewAssertions.matches(MatcherUtils.PageMatcher(0)))
  }
