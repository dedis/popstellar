...
import static com.github.dedis.popstellar.testutils.pages.lao.socialmedia.SocialMediaProfilePageObject.getRootView;
import static com.github.dedis.popstellar.testutils.pages.lao.socialmedia.SocialMediaProfilePageObject.getSocialMediaHomeFragment;
import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertTrue;

@HiltAndroidTest
@RunWith(AndroidJUnit4.class)
public class SocialMediaProfileFragmentTest {
  ...
  @Rule(order = 3)
  public ActivityFragmentScenarioRule<LaoActivity, SocialMediaProfileFragment>
      activityScenarioRule =
          ActivityFragmentScenarioRule.launchIn(
              LaoActivity.class,
              new BundleBuilder().putString(Constants.LAO_ID_EXTRA, LAO_ID).build(),
              LaoActivityPageObject.containerId(),
              SocialMediaProfileFragment.class,
              SocialMediaProfileFragment::new);
    ...
    activityScenarioRule
        ...
        .onActivity(
            activity -> {
              ...
              assertTrue(after instanceof SocialMediaProfileFragment);
            });
  }
}
