...
import com.github.dedis.popstellar.testutils.pages.lao.socialmedia.SocialMediaFollowingPageObject
...
class SocialMediaFollowingFragmentTest {
  ...
  var activityScenarioRule:
    ActivityFragmentScenarioRule<LaoActivity, SocialMediaFollowingFragment> =
    ActivityFragmentScenarioRule.launchIn(
      ...
      SocialMediaFollowingFragment::class.java
    ) {
      SocialMediaFollowingFragment()
    }

  @Test
  fun testBackButtonBehaviour() {
    SocialMediaFollowingPageObject.getRootView().perform(ViewActions.pressBack())
    // Check current fragment displayed is home fragment
    SocialMediaFollowingPageObject.getSocialMediaHomeFragment()
