...
public class Server {
  ...
  // As soon as a greeting message arrives in the future, we connect to all peers. The server addresses
  // will be added to the lao state as soon as a lao creation message is received
  // over each connection

  /**
   * Instantiate a server, for now it's a basic object which holds data about it,
   * later, it will be serialized and added to a list of peers server for 1 client
   * --> multiple server
