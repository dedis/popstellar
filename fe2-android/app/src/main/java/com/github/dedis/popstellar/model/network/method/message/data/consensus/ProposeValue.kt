...
@Immutable
class ProposeValue(@JvmField @field:SerializedName("proposed_try") val proposedTry: Int,
    ...
    override fun toString(): String {
        return String.format(
                "ProposeValue{proposed_try=%s, proposed_value=%b}", proposedTry, isProposedValue)
    }
}