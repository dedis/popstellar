...
import com.github.dedis.popstellar.detail.adapters.CastVoteViewPagerAdapter;
...
public class CastVoteFragment extends Fragment {
  ...
  private View.OnClickListener buttonListener = v -> {
    ...
    List<ElectionQuestion> electionQuestions = mLaoDetailViewModel.getCurrentElection()
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    CastVoteViewPagerAdapter adapter = new CastVoteViewPagerAdapter(mLaoDetailViewModel,
