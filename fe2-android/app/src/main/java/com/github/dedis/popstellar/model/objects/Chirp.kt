...
class Chirp : Copyable<Chirp?> {
    ...
    constructor(
            ...
            text: String,
            timestamp: Long,
            parentId: MessageID) : this(id, sender, text, timestamp, false, parentId)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return timestamp == chirp.timestamp && isDeleted == chirp.isDeleted && id == chirp.id &&
                sender == chirp.sender && text == chirp.text && parentId == chirp.parentId
    }
    ...
    override fun toString(): String {
        return String.format(
                ...
                id.encoded, sender, text, timestamp, isDeleted, parentId.encoded)
    }
