...
public final class RollCallEvent {
  ...
  //      throw new IllegalArgumentException("Trying to create a meeting event with null
  // parameters");
  //    }
  ...
  //    return
  // rollCalls.stream().map(RollCallEvent::transformRollCall).collect(Collectors.toList());
  //  }
  //
  ...
  //    return Objects.equals(endTime, that.endTime) && Objects.equals(description,
  // that.description);
  //  }
  //
  //  @Override
