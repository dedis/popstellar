...
@Immutable
class AcceptValue(@JvmField @field:SerializedName("accepted_try") val acceptedTry: Int,
    ...
    override fun toString(): String {
        return String.format(
                "AcceptValue{accepted_try=%s, accepted_value=%b}", acceptedTry, isAcceptedValue)
    }
}