 ...
 *
 * <p>Copyright [2015] [Stellar Development Foundation]
 *
 ...
 *
 * <p>----- <a href="https://github.com/stellar/java-stellar-sdk/blob/master/LICENSE">LICENSE</a> <a
 * href="https://github.com/stellar/java-stellar-sdk/blob/master/src/main/java/org/stellar/sdk/SLIP10.java">GITHUB
 * FILE</a>. <a
 * href="https://github.com/stellar/java-stellar-sdk/commit/a63d97970aff6121637235944be9c4ec48aa4fa2">GITHUB
 * COMMIT</a>.
 */
public final class SLIP10 {
  ...
  public static byte[] deriveEd25519PrivateKey(final byte[] seed, final int... indexes)
    ...
    mac.init(
        new SecretKeySpec("ed25519 seed".getBytes(StandardCharsets.UTF_8), HMAC_SHA_512_ALGORITHM));
    mac.update(seed);
