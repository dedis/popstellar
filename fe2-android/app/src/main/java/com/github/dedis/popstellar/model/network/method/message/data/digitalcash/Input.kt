 ...
 */(// Previous (to-be-used) transaction hash
        @JvmField @field:SerializedName("tx_out_hash") val txOutHash: String, // index of the previous to-be-used transaction
        @JvmField @field:SerializedName("tx_out_index") val txOutIndex: Int, // The script describing the unlock mechanism
        @JvmField @field:SerializedName("script") val script: ScriptInput) {
