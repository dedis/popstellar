...
class CreateMeeting : Data {
    ...
    constructor(
            laoId: String?, name: String, creation: Long, location: String?, start: Long, end: Long) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return creation == that.creation && start == that.start && end == that.end && id == that.id
                && name == that.name && getLocation() == that.getLocation()
    }

    override fun hashCode(): Int {
        return java.util.Objects.hash(
                id, name, creation, getLocation(), start, end)
    }
