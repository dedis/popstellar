...
public class CloseRollCall extends Data {
  ...
  public boolean equals(Object o) {
    ...
    return getClosedAt() == that.getClosedAt()
        && java.util.Objects.equals(getUpdateId(), that.getUpdateId())
        && java.util.Objects.equals(getCloses(), that.getCloses())
        && java.util.Objects.equals(getAttendees(), that.getAttendees());
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(getUpdateId(), getCloses(), getClosedAt(), getAttendees());
  }
