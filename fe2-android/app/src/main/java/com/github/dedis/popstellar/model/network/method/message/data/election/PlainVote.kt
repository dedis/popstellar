...
class PlainVote : Vote {
     ...
     */
    constructor(
            questionId: String, vote: Int?, writeInEnabled: Boolean, writeIn: String?, electionId: String?) {
        this.questionId = questionId
        this.vote = if (writeInEnabled) null else vote
        id = Election.generateElectionVoteId(electionId, questionId, vote, writeIn, writeInEnabled)
    }
