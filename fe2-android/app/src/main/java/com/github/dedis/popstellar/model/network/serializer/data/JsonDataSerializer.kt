...
class JsonDataSerializer(private val dataRegistry: DataRegistry) : JsonSerializer<Data>, JsonDeserializer<Data> {
    ...
    override fun serialize(src: Data, typeOfSrc: Type, context: JsonSerializationContext): JsonElement {
