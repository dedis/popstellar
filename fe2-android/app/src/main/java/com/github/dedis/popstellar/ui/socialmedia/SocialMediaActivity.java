  ...
  private void setupSocialMediaHomeFragment() {
    SocialMediaHomeFragment socialMediaHomeFragment =
        (SocialMediaHomeFragment)
            getSupportFragmentManager().findFragmentById(R.id.fragment_social_media_home);
  ...
  private void setupSocialMediaSendFragment() {
    SocialMediaSendFragment socialMediaSendFragment =
        (SocialMediaSendFragment)
            getSupportFragmentManager().findFragmentById(R.id.fragment_social_media_send);
  ...
  private void setupSocialMediaFollowingFragment() {
    SocialMediaFollowingFragment socialMediaFollowingFragment =
        (SocialMediaFollowingFragment)
            getSupportFragmentManager().findFragmentById(R.id.fragment_social_media_following);
  ...
  private void setupSocialMediaProfileFragment() {
    SocialMediaProfileFragment socialMediaProfileFragment =
        (SocialMediaProfileFragment)
            getSupportFragmentManager().findFragmentById(R.id.fragment_social_media_profile);
