...
public class ScriptTxIn {
  ...
  public ScriptTxIn(String type, String pub_key_recipient, String sig) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(type, that.type) && Objects.equals(pub_key_recipient, that.pub_key_recipient) && Objects.equals(sig, that.sig);
    }
    ...
    public String toString() {
        return "ScriptTxIn{" +
                "type='" + type + '\'' +
                ", pub_key_recipient='" + pub_key_recipient + '\'' +
                ", sig='" + sig + '\'' +
                '}';
    }
}
