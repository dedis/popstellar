...
class DigitalCashIssueFragment : Fragment() {
  ...
  private fun issueCoins() {
    ...
    val currentPublicKeySelected =
        findPublicKeyFromUsername(binding.digitalCashIssueSpinner.editText!!.text.toString(), digitalCashViewModel.attendeesFromTheRollCallList, digitalCashViewModel.validToken.publicKey)
