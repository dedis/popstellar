package com.github.dedis.popstellar.detail.fragments.event.creation;
...
import com.github.dedis.popstellar.detail.adapters.ElectionSetupViewPagerAdapter;
import com.github.dedis.popstellar.detail.transformers.ZoomOutTransformer;
...
public class ElectionSetupFragment extends AbstractEventCreationFragment {
  ...
  private final TextWatcher submitTextWatcher =
      new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before,
            int count) {/* no check to make during the text is being changes */}
  ...
  public View onCreateView(
    ...
    viewPagerAdapter.isAnInputValid().observe(this,
