...
class ElectInstance : Copyable<ElectInstance?> {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return messageId == that.messageId && channel == that.channel && proposer == that.proposer
                && elect == that.elect && nodes == that.nodes &&
                acceptorToMessageId == that.acceptorToMessageId && state == that.state
    }
    ...
    enum class State {
        FAILED, WAITING, STARTING, ACCEPTED
    }
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun generateConsensusId(
                type: String, id: String, property: String): String {
