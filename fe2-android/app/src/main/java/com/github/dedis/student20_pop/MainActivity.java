...
public final class MainActivity extends FragmentActivity {
  ...
  //          showFragment(new QRCodeScanningFragment(CONNECT_LAO, null),
  // QRCodeScanningFragment.TAG);
  //        else
  //          showFragment(
  ...
  //        if (name.isEmpty()) {
  //          Toast.makeText(
  //                  this, getString(R.string.exception_message_empty_lao_name),
  // Toast.LENGTH_SHORT)
  //              .show();
  //        } else {
  ...
  //
  //  @Override
  //  public void onQRCodeDetected(String url, QRCodeScanningType qrCodeScanningType, String
  // eventId) {
  ...
  //    showFragment(new QRCodeScanningFragment(qrCodeScanningType, null),
  // QRCodeScanningFragment.TAG);
  //  }
}
