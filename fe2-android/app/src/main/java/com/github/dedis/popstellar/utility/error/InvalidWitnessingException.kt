...
class InvalidWitnessingException : DataHandlingException {
     ...
     */
    constructor(data: Data, witnessPublicKey: PublicKey) : super(
        data,
        "No witness with public key $witnessPublicKey exists in the lao"
    )
     ...
     */
    constructor(data: Data, messageID: MessageID) : super(
        data,
        "No witness message with id $messageID exists in the lao"
    )
}