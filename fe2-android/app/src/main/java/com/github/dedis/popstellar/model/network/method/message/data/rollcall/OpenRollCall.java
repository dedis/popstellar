...
public class OpenRollCall extends Data {
  ...
  public boolean equals(Object o) {
    ...
    return getOpenedAt() == that.getOpenedAt()
        && java.util.Objects.equals(getUpdateId(), that.getUpdateId())
        && java.util.Objects.equals(getOpens(), that.getOpens())
        && java.util.Objects.equals(getAction(), that.getAction());
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(getUpdateId(), getOpens(), getOpenedAt(), getAction());
  }
