...
public class HomeViewModel extends AndroidViewModel
  ...
  private final MutableLiveData<SingleEvent<Boolean>> mOpenServerUrl = new MutableLiveData<>();
  private final MutableLiveData<SingleEvent<Boolean>> mSetServerUrlEvent = new MutableLiveData<>();
  ...
  public LiveData<SingleEvent<Boolean>> getOpenServerUrl() {
    return mOpenServerUrl;
  }
  ...
  public LiveData<SingleEvent<Boolean>> getSetServerUrlEvent() {
    return mSetServerUrlEvent;
  }
  ...
  public void openServerUrl() {
    mOpenServerUrl.setValue(new SingleEvent<>(true));
  }
  ...
  public void setServerUrlEvent() {
    mSetServerUrlEvent.setValue(new SingleEvent<>(true));
  }
  ...
  public void setServerUrl(String name) {
    this.mServerUrl.setValue(name);
  }

  public void serverUrl() {
    Injection.setServerUrl(mServerUrl.getValue());
  }
}
