...
public interface HighLevelProxy extends Closeable {
   ...
   * @return a CompletableFuture that will be complete once the back end responses
   */
  CompletableFuture<Integer> updateLao(
   ...
   * @return a CompletableFuture that will be complete once the back end responses
   */
  CompletableFuture<Integer> createMeeting(
   ...
   * @param creation time
   * @param start of the roll call. Could be immediate and therefore the startType field should be
   *     NOW. If it is in the future, startType should be SCHEDULED
   * @param startType of the roll call
   * @param location of the roll call
   * @return a CompletableFuture that will be complete once the back end responses
   */
  CompletableFuture<Integer> createRollCall(
      String laoId,
      String name,
      long creation,
      long start,
   ...
   * @return a CompletableFuture that will be complete once the back end responses
   */
  CompletableFuture<Integer> closeRollCall(
